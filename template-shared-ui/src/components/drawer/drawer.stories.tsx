...
import { Drawer, DrawerDescription, DrawerTitle, DrawerTrigger } from './drawer'
import { DrawerClose, DrawerContent, DrawerFooter, DrawerHeader } from './drawer'
    ...
    <Drawer>
      ...
      <DrawerContent>
        <DrawerHeader>
          ...
          <DrawerDescription>View complete product information</DrawerDescription>
        </DrawerHeader>
        <div className="p-4">
          ...
          <p className="mb-4 text-muted-foreground">
            ...
            voluptatum, quae voluptatibus quas quidem voluptatem quibusdam quos quia nesciunt.
          </p>
