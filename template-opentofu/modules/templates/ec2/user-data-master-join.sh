...
while [ $attempt -le $max_attempts ]; do
    ...
    if MANAGER_TOKEN=$(aws ssm get-parameter \
       ...
       MASTER_IP=$(aws ssm get-parameter \
        ...
        echo "Successfully retrieved swarm information"
        ...
        if docker swarm join --token $MANAGER_TOKEN $MASTER_IP; then
            echo "Successfully joined the swarm as a manager"
        ...
        echo "Failed to retrieve swarm information on attempt $attempt"
