...
use {{ package_name | snake_case }}::core::database::Database;
use {{ package_name | snake_case }}::core::env::Env;
use {{ package_name | snake_case }}::core::instrumentation::init_observability;
use {{ package_name | snake_case }}::repository::openai::greeting::GreetingRepoOpenAI;
use {{ package_name | snake_case }}::services::greeting::GreetingService;
